/*
    ENC28J60 Ethernet modul driver header.
*/
...
// No routine needs to alter below. Also, alter only with care.
...
#define ETXST (0x1FFF - (MAX_TX_PACKET + 7)) // TX Start. 7 bytes spare for status (p33 datasheet)
...
void setClockout25MHz();
void setClockout12pt5MHz();
void setClockout8pt33MHz();
void setClockout6pt25MHz();
void setClockout3pt125MHz();
